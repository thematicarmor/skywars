...
public record SkyWarsConfig(
    ...
    public static final Codec<SkyWarsConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.optionalFieldOf("spawn_loot_table", new Identifier("minigamemanager", "skywars/spawn/default")).forGetter(SkyWarsConfig::spawnLootTable),
            Identifier.CODEC.optionalFieldOf("center_loot_table", new Identifier("minigamemanager", "skywars/center/default")).forGetter(SkyWarsConfig::centerLootTable),
